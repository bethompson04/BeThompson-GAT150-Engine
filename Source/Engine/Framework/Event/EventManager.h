...
#define EVENT_SUBSCRIBE(id, function)	MEN::EventManager::Instance().Subscribe(id, this, std::bind(&function, this, std::placeholders::_1))
#define EVENT_UNSUBSCRIBE(id)			MEN::EventManager::Instance().Unsubscribe(id, this)
